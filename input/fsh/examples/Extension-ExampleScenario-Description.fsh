Extension: ExampleScenarioDescription
Id: ExampleScenarioDescription
Title: "ExampleScenario Description"
Description: "When you want to add a description to an ExampleScenario."
* ^meta.versionId = "1"
* ^version = "0.1.0"
